...
{	
    ...
    public gridButton(String mask, int pg, int xIn, int yIn, int wdt, int hgt, int chan, int val, int mx, int mn, double mxF, double mnF, int spd, int fspd,int lH, int lL, int opt1, int opt2, int d)
    {
        setMask(mask);
